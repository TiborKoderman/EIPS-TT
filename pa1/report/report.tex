...
in \texttt{crawldb.frontier_queue}), and workers always claim the currently due URL with the highest priority.
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        Number of sites              & \texttt{174}           & \texttt{[TBD]} \\
        Number of HTML pages         & \texttt{1001}           & \texttt{[TBD]} \\
