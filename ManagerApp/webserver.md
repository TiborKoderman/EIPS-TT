...
- **Trap suppression:** manager frontier enqueue rejects likely crawler-trap redirect loops (for example recursively encoded `ReturnURL` login patterns) before they enter queue state.
